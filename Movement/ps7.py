...
class RectangularRoom(object):
    ...
    def __init__(self, width, height):
        ...
        self.h= height
        self.numberclean=0
        self.matrix= [ [False for y in range(0,height) ] for x in range (0,width) ]
...
class StandardRobot(Robot):
    ...
    def updatePositionAndClean(self):
        ...
        #Obtain new pos
        newpos= oldpos.getNewPosition(angle,speed)
        
        #Cheek that the new position is in the room
