...
from Tkinter import *
from Problems.Triguers import TitleTrigger, AndTrigger
...
def filterStories(stories, triggerlist):
    ...
    for s in stories:
        ...
        for t in triggerlist:
            if(t.evaluate(s) and count<1):
                count+=1
                list_TrigStories.append(s)
    return list_TrigStories
...
def makeTrigger(triggerMap, triggerType, params, name):
    ...
    if(triggerType== 'TITLE'):
        ...
        t=NotTrigger(params[0])
    elif(triggerType== 'AND'):
        t=AndTrigger(params[0],params[1])
    elif(triggerType== 'OR'):
        t=OrTrigger(params[0],params[1])
