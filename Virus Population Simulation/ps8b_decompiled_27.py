...
def simulationWithDrugTimeHist(numViruses, maxPop, maxBirthProb, clearProb, resistances, mutProb, numTrials
    ...
    pylab.figure()
    pylab.hist(totalViruses,bins=20)
    pylab.title(title)
    pylab.xlabel('Final total viruss population values')
    pylab.ylabel('Number of trials')
    #pylab.semilogy()
    pylab.legend(loc='best')
    
#     pylab.figure()
#     pylab.hist(resistant,bins=50)
#     pylab.title(title)
#     pylab.xlabel('Final resistant virus population values')
#     pylab.ylabel('Number of trials')
#     pylab.legend(loc='best')
#     
...
def simulationWithDrugTimePlot(numViruses, maxPop, maxBirthProb, clearProb, resistances, mutProb, numTrials
                           ,numStepsBeforeDrugApplied,totalNumSteps, title):
    """
       Runs simulations and plots graphs for problem 5.
 
        For each of numTrials trials, instantiates a patient, runs a simulation for
        numStepsBeforeDrugApplied timesteps, adds guttagonol,
        and runs the simulation for (numStepsBeforeDrugApplied +  150) timesteps. 
...
# +++ okay decompyling ps8b_precompiled_27.pyc
# decompiled 1 files: 1 okay, 0 failed, 0 verify failed
# 2013.04.19 15:05:44 EST
